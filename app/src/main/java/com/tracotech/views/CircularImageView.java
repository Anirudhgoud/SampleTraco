...
/**
 * Created by Anirudh on 11/30/2016.
 */
...
public class CircularImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init() {
      ...
      /*  textPaint.setColor(Color.WHITE);
        ...
        textPaint.setTextSize(scale * 18);
    ...
    public void setScaleType(ScaleType scaleType) {
        if (scaleType != SCALE_TYPE) {
            throw new IllegalArgumentException(getContext().getString(R.string.scale_type_not_supported));
        }
    }
    ...
    public void setAdjustViewBounds(boolean adjustViewBounds) {
        if (adjustViewBounds) {
            throw new IllegalArgumentException(getContext().getString(R.string.adjust_view_not_supported));
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int tW = bounds.width();
        int xPos = canvas.getWidth() / 2 - tW / 2;
        int yPos = canvas.getHeight() / 2 + tH / 2;
